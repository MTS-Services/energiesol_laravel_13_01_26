...
export default function partner() {
  ...
  <div className='relative z-10 mx-auto max-w-7xl py-10 lg:py-15 grid grid-cols-2 px-4 lg:px-0 lg:grid-cols-4 gap-4 lg:gap-6 place-items-center'>
    ...
    <img src="/images/logo3.png" alt="Partner Logo 3" className='w-full h-10 lg:h-17 hidden lg:inherit'/>
    <img src="/images/logo4.png" alt="Partner Logo 4" className='w-full h-10 lg:h-17 hidden lg:inherit'/>
  </div>
</div>
  )
}
