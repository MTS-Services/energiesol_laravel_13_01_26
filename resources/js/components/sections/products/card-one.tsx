       ...
       <div className=' border border-secondary/20 py-20 rounded-md'>
         <div className='flex justify-center items-center flex-col border-b border-secondary/20 px-6 lg:px-64'>
              <div className="mb-3 flex flex-row items-center justify-start gap-3">
                ...
                <div className='mt-2'>
                    <h2 className='text-seoncary font-semibold font-montserrat text-2xl lg:text-[32px] text-center'>High-Efficiency Solar Panels</h2>
                </div>
                <div className='mt-2 pb-7'>
                    <p className='text-secondary/70 font-open-sans text-base lg:text-lg text-center'>
                        Our solar panels are engineered to capture maximum sunlight and convert it into clean, reliable electricity. Built for durability and optimal performance, they ensure consistent energy production throughout the year.
                    </p>
                </div>
         </div>
