                ...
                <div className="relative z-10 mx-auto max-w-7xl px-6 pt-40 pb-24 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
                    <div className="col-span-1 w-full lg:w-3/5">
                        ...
                        <div className="inline-flex gap-3 pt-2">
                            ...
                            Professional Energy 
                              <div className='inline-block lg:inline-flex'>
                                 <span className="pr-2 font-playfair-display text-4xl md:text-[56px] font-semibold text-info italic inline-block lg:block">
                                    Energy
                                </span> Solutions.
                              </div>
                            </h2>
                        ...
                        <div className="pt-3 pb-8">
                            ...
                            As your dedicated full-service solar provider, we offer end-to-end support nationwide. Our experts guide you through the entire journey, from your initial inquiry to the final activation of your custom energy system.
                            </p>
                        </div>
                        <div>
