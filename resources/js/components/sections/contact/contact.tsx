...
function Contact() {
    return (
        <div id='contact' className="relative isolate z-10  bg-linear-to-r from-btn-primary/15 to-info/5">
            <div
            ...
            <div className="z-10 mx-auto flex max-w-7xl flex-col items-center justify-center px-6 py-10 lg:px-0 lg:py-20">
                ...
                <div className="mb-5 flex flex-col items-start justify-start lg:mb-10 lg:items-center lg:justify-center">
                    <h2 className="mb-2 text-center font-montserrat text-3xl font-semibold lg:text-[40px] lg:px-40 px-0">
                        Bringen Sie <span className='text-info'>Power</span> in Ihr Zuhause. <span className='text-info'>Jetzt</span> Nachricht senden.
                    </h2>
