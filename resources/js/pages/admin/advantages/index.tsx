...
interface Props {
  advantages: Advantage[]; // Changed from solarPanels to advantages
...
export default function Index({advantages, pagination, offset, filters, search, sortBy, sortOrder}: Props) {
  ...
  const columns: ColumnConfig<Advantage>[] = [ // Changed from SolarPanels to Advantage
    {
      key: 'title',
      label: 'Title',
      sortable: true,
  ...
  const actions: ActionConfig<Advantage>[] = [ // Changed from SolarPanels to Advantage
    {
      label: 'View',
    ...
    },
    {
      ...
      onClick: (advantage) => {
        router.visit(edit.url(advantage.id));
      },
    },
    {
      label: 'Delete',
   ...
   return (
    <AdminLayout activeSlug="admin-advantages"> {/* Changed activeSlug */}
      ...
      <div className="mx-auto">
        <DataTable
          data={advantages} // Changed from solarPanels to advantages
          columns={columns}
          ...
          sortOrder={sortOrder}
          isLoading={isLoading}
          emptyMessage="No advantages found" // Changed empty message
          searchPlaceholder="Search advantages by title..." // Changed search placeholder
        />
      </div>
    </AdminLayout>
  );
