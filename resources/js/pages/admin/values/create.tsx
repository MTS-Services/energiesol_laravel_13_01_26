...
import { store, index } from '@/actions/App/Http/Controllers/Admin/ValueController';
...
export default function CreateValue() {
  ...
  return (
    <AdminLayout activeSlug="values">
      <Head title="Create Value" />
      
      <CardHeader className="flex flex-row items-center justify-between">
        <h1 className="text-2xl font-bold">Create New Value</h1>
                ...
                <CardContent className="pt-6">
                  <div className="flex flex-row justify-between gap-3">
                    ...
                    >
                      ...
                      {processing ? 'Creating...' : 'Create Value'}
                    </Button>
                    <ActionButton
                      IconNode={ArrowLeft}
                      href={index.url()}
