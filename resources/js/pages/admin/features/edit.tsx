import {
    ...
    show,
    update,
} from '@/actions/App/Http/Controllers/Admin/FeatureController';
...
export default function EditFeature({ feature }: Props) {
          ...
          setImage([
            {
                ...
                name: feature.image?.split('/').pop() || 'image',
                mime_type: 'image/*',
                path: feature.image || '',
            },
        ]);
    ...
    return (
        <AdminLayout activeSlug="admin-features">
